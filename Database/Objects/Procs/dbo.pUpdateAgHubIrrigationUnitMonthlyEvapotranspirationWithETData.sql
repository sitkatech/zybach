...
begin
	...
	USING
	(
		SELECT ahiu.AgHubIrrigationUnitID, wym.WaterYearMonthID, ogbretd.EvapotranspirationRateInches, (ogbretd.EvapotranspirationRateInches / 12) * ahiu.IrrigationUnitAreaInAcres as etraf
	...
	WHEN MATCHED THEN
		update set Target.EvapotranspirationRateInches = Source.EvapotranspirationRateInches,
				   Target.EvapotranspirationRateAcreFeet = Source.etraf
