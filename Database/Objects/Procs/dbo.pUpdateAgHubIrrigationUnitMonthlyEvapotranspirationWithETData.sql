...
begin
	...
	USING
	(
		SELECT ahiu.AgHubIrrigationUnitID, wym.WaterYearMonthID, ogbretd.EvapotranspirationRateInches
		...
		join WaterYearMonth wym on wym.[Year] = ogbretd.[WaterYear] and wym.[Month] = ogbretd.[WaterMonth]
	) AS Source
    ...
    WHEN NOT MATCHED by Target THEN
		insert (AgHubIrrigationUnitID, WaterYearMonthID, EvapotranspirationRateInches) values 
		(Source.AgHubIrrigationUnitID, Source.WaterYearMonthID, Source.EvapotranspirationRateInches);
end