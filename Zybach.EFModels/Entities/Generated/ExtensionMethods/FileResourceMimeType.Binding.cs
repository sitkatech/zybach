...
namespace Zybach.EFModels.Entities
{
    public abstract partial class FileResourceMimeType : IHavePrimaryKey
    {
        ...
        public static readonly FileResourceMimeTypeExcelXLSX ExcelXLSX = Zybach.EFModels.Entities.FileResourceMimeTypeExcelXLSX.Instance;
        public static readonly FileResourceMimeTypeXPNG XPNG = Zybach.EFModels.Entities.FileResourceMimeTypeXPNG.Instance;
        public static readonly FileResourceMimeTypePNG PNG = Zybach.EFModels.Entities.FileResourceMimeTypePNG.Instance;
        public static readonly FileResourceMimeTypeTIFF TIFF = Zybach.EFModels.Entities.FileResourceMimeTypeTIFF.Instance;
        public static readonly FileResourceMimeTypeBMP BMP = Zybach.EFModels.Entities.FileResourceMimeTypeBMP.Instance;
        public static readonly FileResourceMimeTypeGIF GIF = Zybach.EFModels.Entities.FileResourceMimeTypeGIF.Instance;
        public static readonly FileResourceMimeTypeJPEG JPEG = Zybach.EFModels.Entities.FileResourceMimeTypeJPEG.Instance;
        public static readonly FileResourceMimeTypePJPEG PJPEG = Zybach.EFModels.Entities.FileResourceMimeTypePJPEG.Instance;
        public static readonly FileResourceMimeTypePowerpointPPTX PowerpointPPTX = Zybach.EFModels.Entities.FileResourceMimeTypePowerpointPPTX.Instance;
        public static readonly FileResourceMimeTypePowerpointPPT PowerpointPPT = Zybach.EFModels.Entities.FileResourceMimeTypePowerpointPPT.Instance;
        public static readonly FileResourceMimeTypeExcelXLS ExcelXLS = Zybach.EFModels.Entities.FileResourceMimeTypeExcelXLS.Instance;
        public static readonly FileResourceMimeTypeWordDOC WordDOC = Zybach.EFModels.Entities.FileResourceMimeTypeWordDOC.Instance;
        public static readonly FileResourceMimeTypexExcelXLSX xExcelXLSX = Zybach.EFModels.Entities.FileResourceMimeTypexExcelXLSX.Instance;
        public static readonly FileResourceMimeTypeCSS CSS = Zybach.EFModels.Entities.FileResourceMimeTypeCSS.Instance;
        public static readonly FileResourceMimeTypeZIP ZIP = Zybach.EFModels.Entities.FileResourceMimeTypeZIP.Instance;
