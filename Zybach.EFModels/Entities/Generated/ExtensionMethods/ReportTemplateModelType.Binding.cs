...
namespace Zybach.EFModels.Entities
{
    public abstract partial class ReportTemplateModelType
    {
        ...
        public static readonly List<ReportTemplateModelTypeDto> AllAsDto;
        public static readonly ReadOnlyDictionary<int, ReportTemplateModelType> AllLookupDictionary;
        public static readonly ReadOnlyDictionary<int, ReportTemplateModelTypeDto> AllAsDtoLookupDictionary;
        ...
        static ReportTemplateModelType()
        {
            ...
            AllAsDto = new List<ReportTemplateModelTypeDto> { SingleModel.AsDto(), MultipleModels.AsDto() };
            AllLookupDictionary = new ReadOnlyDictionary<int, ReportTemplateModelType>(All.ToDictionary(x => x.ReportTemplateModelTypeID));
            AllAsDtoLookupDictionary = new ReadOnlyDictionary<int, ReportTemplateModelTypeDto>(AllAsDto.ToDictionary(x => x.ReportTemplateModelTypeID));
        }
        ...
        public ReportTemplateModelTypeEnum ToEnum => (ReportTemplateModelTypeEnum)GetHashCode();
