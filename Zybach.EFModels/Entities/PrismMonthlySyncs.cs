...
{
    public static async Task<List<PrismDailyRecordSimpleDto>> ListByYearMonthAndDataType(ZybachDbContext dbContext, int year, int month, PrismDataType prismDataType)
    {
