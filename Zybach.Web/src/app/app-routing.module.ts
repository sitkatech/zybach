...
const routes: Routes = [
  ...
  { path: "wells/:id/new-support-ticket", component: SupportTicketEditComponent, canActivate: [UnauthenticatedAccessGuard, ReadOnlyGuard, AcknowledgedDisclaimerGuard] },
