...
namespace Zybach.API.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public UserController(ZybachDbContext dbContext, ILogger<UserController> logger, KeystoneService keystoneService, IOptions<ZybachConfiguration> zybachConfigurationOptions)
        {
        ...
        public ActionResult<UserDto> GetByGlobalID([FromRoute] string globalID)
        {
            ...
            var userDto = Zybach.EFModels.Entities.User.GetByUserGuid(_dbContext, globalIDAsGuid);
            if (userDto == null)
            {
                return NotFound();
            }
        ...
        public ActionResult<UserDto> UpdateUser([FromRoute] int userID, [FromBody] UserUpsertDto userUpsertDto)
        {
            ...
            var validationMessages = Zybach.EFModels.Entities.User.ValidateUpdate(_dbContext, userUpsertDto, userDto.UserID);
