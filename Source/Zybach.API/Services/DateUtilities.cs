...
namespace Zybach.API.Services
{
    public static class DateUtilities
    {
        ...
        /// <summary>
        /// Tests if two given pezybachds overlap each other.
        /// </summary>
        /// <param name="startDate1">Base pezybachd start</param>
        /// <param name="endDate1">Base pezybachd end</param>
        /// <param name="startDate2">Test pezybachd start</param>
        /// <param name="endDate2">Test pezybachd end</param>
        /// <returns>
        /// 	<c>true</c> if the pezybachds overlap; otherwise, <c>false</c>.
        /// </returns>
