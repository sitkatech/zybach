...
namespace DroolTool.API.Services
{
    public static class DateUtilities
    {
        ...
        /// <summary>
        /// Tests if two given pedrooltoolds overlap each other.
        /// </summary>
        /// <param name="startDate1">Base pedrooltoold start</param>
        /// <param name="endDate1">Base pedrooltoold end</param>
        /// <param name="startDate2">Test pedrooltoold start</param>
        /// <param name="endDate2">Test pedrooltoold end</param>
        /// <returns>
        /// 	<c>true</c> if the pedrooltoolds overlap; otherwise, <c>false</c>.
        /// </returns>
