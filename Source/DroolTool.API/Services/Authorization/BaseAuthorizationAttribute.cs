...
namespace DroolTool.API.Services.Authorization
{
    public abstract class BaseAuthorizationAttribute : AuthorizeAttribute, IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            var dbContextService = context.HttpContext.RequestServices.GetService(typeof(DroolToolDbContext));
            if (dbContextService == null || !(dbContextService is DroolToolDbContext dbContext))
            {
                //MK 1/16/2018 - If we don't have a repository we are in a terrible state.
                throw new ApplicationException(
                    "Could not find injected DroolToolDbRepository. WithRightsAttribute.cs needs your help!");
            }
