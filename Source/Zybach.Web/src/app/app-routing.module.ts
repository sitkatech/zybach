...
const routes: Routes = [
  ...
  { path: "chemigation-permits/:permit-number/:record-year/:inspection-id/edit",  component: ChemigationInspectionEditComponent, canActivate: [UnauthenticatedAccessGuard, AcknowledgedDisclaimerGuard]},
