...
@NgModule({
  declarations: [
    ...
    WaterLevelInspectionListComponent, WellContactEditComponent, WellParticipationEditComponent, WellRegistrationIdEditComponent, ClearinghouseWqiReportComponent, SensorListComponent
  ],
  imports: [
    AppRoutingModule,
    BrowserModule,
