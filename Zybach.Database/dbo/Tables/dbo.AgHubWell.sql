CREATE TABLE [dbo].[AgHubWell](
	...
	[AgHubIrrigationUnitID] [int] NULL,
...
GO
ALTER TABLE [dbo].[AgHubWell]  WITH CHECK ADD  CONSTRAINT [FK_AgHubWell_AgHubIrrigationUnit_AgHubIrrigationUnitID] FOREIGN KEY([AgHubIrrigationUnitID])
REFERENCES [dbo].[AgHubIrrigationUnit] ([AgHubIrrigationUnitID])
GO
ALTER TABLE [dbo].[AgHubWell] CHECK CONSTRAINT [FK_AgHubWell_AgHubIrrigationUnit_AgHubIrrigationUnitID]
GO
