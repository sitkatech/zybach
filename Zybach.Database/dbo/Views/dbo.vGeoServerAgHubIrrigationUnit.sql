...
select AgHubIrrigationUnitID, WellTPID, IrrigationUnitGeometry, IrrigationYear, Acres, CropType, CropTypeLegendDisplayName, CropTypeMapColor, 
	Tillage, TillageTypeLegendDisplayName, TillageTypeMapColor
from
(
